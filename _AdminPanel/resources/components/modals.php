        ...
        <div class="modal-body">
            <form id="uploader-slider" name="uploader-slider" action="../../../app/controllers/uploader-slider.php" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <span class="help-block">Solo se permiten archivos en formato JPG o PNG, con un tamaño máximo de 2MB y una resolución FullHD</span>
                </div>
                <div class="form-group">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form method="POST" id="deleteSlider">
        ...
        <button type="submit" class="btn btn-danger" onclick="window.location.reload();">Eliminar</button>
      </form>
      </div>
  </div>
</div>
    ...
    <div class="modal-dialog">
      <!-- Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="modal" onclick="window.location.reload();">Cerrar</button>
              <button type="submit" form="formEditServices" class="btn btn-success">Guardar</button>
            </div>
        </div>
    </div>
</div>
