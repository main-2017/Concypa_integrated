...
if (!empty(['HTTP_X_REQUESTED_WITH'])&& strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
	...
	$query = $mysqli->query("SELECT * FROM proyectos WHERE Visible = 1 AND Estado = 'Terminado'");
			...
			$return.="<div class='sr-icons col-lg-4 col-md-6 col-sm-12 col-xs-12 box-content-project' style='padding-left: 0px;'>
						<div class='box-project'>
							...
							<div class='cover'>
								...
								<button data-toggle='modal' data-target='#modal-end-".$i."' class='flat-button' type='button'><span><img class='icon-toggle' src='img/general/icon-next.png' alt='toggle'></span>Ver Proyecto</button>
							</div>
						</div>
					</div>
				
					<!--Model #".$i."-->
					<div class='modal fade' id='modal-end-".$i."' tabindex='-1' role='dialog' aria-labelledby='myModalLabel'>
