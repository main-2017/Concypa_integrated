	...
	<footer>
		...
		<div class="row">
			<ul class="social-icon">
				<li class="sr-button"><a id="google" target="_blank" class="social-a" href="#"><span class="icon-google-plus"></span></a></li>
				<li class="sr-button"><a id="facebook" target="_blank" class="social-a" href="#"><span class="icon-facebook"></span></a></li>
				<li class="sr-button"><a id="twitter" target="_blank" class="social-a" href="https://twitter.com/CONCYPA_SA"><span class="icon-twitter"></span></a></li>
				<li class="sr-button"><a id="youtube" target="_blank" class="social-a" href="#"><span class="icon-youtube"></span></a></li>
				<li class="sr-button"><a id="linkedin" target="_blank" class="social-a" href="#"><span class="icon-linkedin2"></span></a></li>
			</ul>
		</div>
