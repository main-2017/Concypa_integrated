...
var flag = true;
	$(document).on('click', "#boton1",function(){
		if (flag) {
			...
			$(this).html("<span><img id='icon1' class='icon-toggle' src='img/general/icon-next.png' alt='toggle'></span>Ver Mas");
...
var flag1 = true;
	$(document).on('click', "#boton2",function(){
		if (flag1) {
			...
			$(this).html("<span><img id='icon2' class='icon-toggle' src='img/general/icon-next.png' alt='toggle'></span>Ver Mas");
	...
	$(document).on('click', "#boton3", function(){
		if (flag2) {
			...
			$(this).html("<span><img id='icon3' class='icon-toggle' src='img/general/icon-next.png' alt='toggle'></span>Ver Mas");
	...
	$(document).on('click', "#boton4", function(){
		if (flag3) {
			...
			$(this).html("<span><img id='icon4' class='icon-toggle' src='img/general/icon-next.png' alt='toggle'></span>Ver Mas");
